...
/obj/item/recipe_book/survival
	name = "Tips, Tricks, & Triumphs: The Novice's Handbook To Lyndvhar"
	desc = "A heftsome tome, filled to the brim with all the information you'd need to survive within Lyndvhar. The golden bookmark seems to always lead you \
