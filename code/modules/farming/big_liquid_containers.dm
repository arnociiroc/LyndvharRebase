...
/obj/structure/fermentation_keg/whitewine
	desc = "A barrel that contains an Valorian luxury. A sweeter tasting wine that often serves to highlight and enhance savoury notes. The rarer the vintage, the harder the find. The names of the ingredients often grow more ostentatious the closer you get to the capital."
