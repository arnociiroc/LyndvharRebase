...
/obj/structure/roguemachine/steward
	name = "nerve master"
	desc = "A magitech device connected to the arteries of Lyndvhar's royal treasury. When unlocked with the proper key, it can sway the fate of an entire kingdom's \
