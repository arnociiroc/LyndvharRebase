...
// Sorry! Commented these guys out. Keeping them in the system for stability's sake. \
... maybe if someone can take a crack at them later on to make them fit in Lyndvhar's environment.
